                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    ...
                                    <div class="card-body" >
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h4 class="font-size-22">Sales</h4>
                                            </div>
                                            <div class="col-md-12">
                                                <ul class="list-inline main-chart text-md-end mb-0">
                                                <li class="list-inline-item chart-border-left me-0 border-0">
                                                    <h4 class="font-size-22" style="color:#1f58c7;">₹3.84L <span class="text-muted d-inline-block font-size-14 align-middle ms-2">Sales</span></h4>
                                                </li>

                                                <li class="list-inline-item chart-border-left me-0 border-0">
                                                    <h4 class="font-size-22" style="color:#8a8f8c;">₹5.84L <span class="text-muted d-inline-block font-size-14 align-middle ms-2">Purchases</span></h4>
                                                </li>

                                                <li class="list-inline-item chart-border-left me-0">
                                                    <h4 class="font-size-22" style="color:#000000;">₹4.97L <span class="text-muted d-inline-block font-size-14 align-middle ms-2">Orders</span></h4>
                                                </li>
                                                </ul>
                                            </div>
                                        </div>
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/dashboard-sales.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jan 2026 07:43:22 GMT -->
</html>