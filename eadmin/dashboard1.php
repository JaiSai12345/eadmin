                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h6 class="mb-0 font-size-15">Orders</h6>
                                            ...
                                            <div class="">
                                                <div class="avatar">
                                                    <div class="avatar-title rounded bg-primary-subtle ">
                                                        <i class="bx bx-shopping-bag font-size-24 mb-0 text-primary"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h6 class="mb-0 font-size-15">Items</h6>
                                            ...
                                            <div class="">
                                                <div class="avatar">
                                                    <div class="avatar-title rounded bg-primary-subtle ">
                                                        <i class="bx bx-layer font-size-24 mb-0 text-primary"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="#">2024-25</a>
                                                        <a class="dropdown-item" href="#">2025-26</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <li class="list-inline-item chart-border-left me-0 border-0">
                                                    <h4 class="font-size-22" style="color: #28b765;">₹13.84L <span class="text-muted d-inline-block font-size-14 align-middle ms-2">Sales</span></h4>
                                                </li>

                                                <li class="list-inline-item chart-border-left me-0 border-0">
                                                    <h4 class="font-size-22" style="color: #1f58c7;">₹65.84L <span class="text-muted d-inline-block font-size-14 align-middle ms-2">Purchases</span></h4>
                                                </li>

                                                <li class="list-inline-item chart-border-left me-0">
                                                    <h4 class="font-size-22" style="color: #564ab1;">3497000 <span class="text-muted d-inline-block font-size-14 align-middle ms-2">Orders</span></h4>
                                                </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div>
                                            <div id="sales-report" data-colors='["#28b765","#1f58c7","#564ab1;"]' class="apex-charts" dir="ltr"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-grow-1">
                                                <h5 class="card-title mb-0">Category-wise Purchase</h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="dropdown">
                                    ...
                                    <div class="card-body"style="height:477px">
                                        <div>
                                            <div id="chart-pie" class="apex-charts" data-colors='["#1f58c7"]'></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-centered align-middle table-nowrap mb-0 table-check" id="tableBody">
                                                <thead>
                                                    <tr>
                                                        <th>S.N</th>
                                                        <th style="width: 90px;">
